    ...
    <Layout>
      ...
      <ContextPortfolio
        ...
        contextContent={
          <>
            <p>
              ...
              success on the mobile market. Nokaut's mobile offering, at the
              time, was limited to a dated mobile version of the core service
              built for old cell phones. This service was highly popular couple
              of years earlier, but with the growing popularity of smartphones,
            ...
            <p>
              ...
              quickly compare prices in brick-and-mortar stores with those
              listed online on thousands of eCommerce website.
            </p>
            <p>
              Due to the strategic partnership with Microsoft, the first target
              platform had to be Windows Mobile (the precursor to Windows
              Phone). Windows Mobile was pre–installed on some of the most
              memorable smartphones of that era – including HTC Diamond.
              Microsoft's mobile OS followed a paradigm of the pre-iPhone
              mobility. The system offered a scaled–down version of the desktop
              operating system. Most of the Windows Mobile devices had to be
              operated with a stylus. Interactive elements were typically small.
              Lots of actions had to be performed from the contextual menu (the
            ...
            <p>
              ...
              feature of our planned experience – the scanner of product
              bar-codes.
            </p>
            <p>
              ...
              quickly scan bar-codes of physical products and browse through
              prices listed online. Thanks to the scanner users could quickly
              ...
              limit the typing was a much desired accessibility feature.
            </p>
            <p>
              Bar-code scanner–the key feature of the app had to be removed from
              the Windows Mobile version. We felt disappointed, but also
              accepting of the reality. Once the Windows Mobile app moved to
              development (development has been done with an external partner),
              our team started to work on iOS and Android versions
              simultaneously. Thanks to the superb documentation of design
              languages for both platforms, design work was significantly more
              comfortable and faster. Reaching the desired level of an engaging
              experience that felt "native" to both Android and iOS users, took
              less time than R&D and design work for Windows Mobile.
            </p>
            <p>
              ...
              We were finally able to fulfill our vision.
            </p>
            <p>
            ...
            <p>
              ...
              and optimize the experience until we've met all of the business
              objectives. After several iterations and making all the details
              right, the app became quite popular. However the impact on revenue
              was smaller than expected. The CPC (cost per click) business model
              wasn't the right fit for the mobile market at that time. Very few
              stores, that Nokaut Skaner redirected users to, were mobile ready.
              Our app was used as a tool to check prices in the store, but the
              purchases were done at home.
            </p>
          </>
        }
        objectivesContent={
          <ol>
            <li>
              Creating an engaging experience that encourages daily usage of
              Grupa Nokaut ecosystem of services.
            </li>
            <li>
        ...
        myRoleContent={
          <ul>
            ...
            <li>
              Coordinating design – development collaboration with the external
              development partner.
            </li>
            <li>
              Defining the information architecture of the app and the user
              interface for the core experiences.
            </li>
            <li>
            ...
            <li>Leading the post-launch optimizations.</li>
          </ul>
        }
      >
        <ImageWrapper>
          <img
            src={NokautSkaner}
            alt="Screenshot of Nokaut Skaner application"
          />
      ...
      <PortfolioResults
        results={
          <ul>
            <li>
              The app quickly became popular among Grupa Nokaut users and became
              the top 5 eCommerce mobile app in Central and Eastern Europe.
            </li>
            <li>
              The app didn't contribute significantly to the revenue generation
              for the business. The CPC business model didn't fit into the
              mobile experience.
            </li>
          </ul>
        }
        lessons={
          <ol>
            ...
            <li>
              Mobile design requires an extreme focus on the overall context of
              use (we've learned a lot by observing users scanning codes of
              products with their phones in real stores).
            </li>
            <li>
              Working with platform constraints can lead to creative solutions
              (e.g., we've enlarged the primary action button using the padding
              of the tab bar).
            </li>
            <li>
              Not every business model fits every use case (CPC business model
              wasn't a match to the mobile eCommerce use case).
            </li>
            <li>
              Working with the external development partners requires clear
